...
<div id="main">
    ...
    $start_date = str_replace('-','',$_POST['startdate']);
    $close_date = str_replace('-','',$_POST['closedate']);

    //echo $start_date.$close_date;
    $start_date = " where dbo.COPTC.TC002>='".$start_date."000'";
    $select_order = "select * from KGI.dbo.COPTC". $start_date;
    $close_date = " and dbo.COPTC.TC002<='".$close_date."999'";
    $select_order = $select_order. $close_date;


    if($_POST['project']!='xxx') {
        $post_project = " and dbo.COPTC.TC056='". $_POST['project']. "'";
        $select_order = $select_order.$post_project;
    }
    if($_POST['business']!='xxx') {
        $post_business = " and dbo.COPTC.TC006='". $_POST['business']. "'";
        $select_order = $select_order.$post_business;
    }
    $select_order = $select_order." order by TC056;";
